...
storage_name = filename.split('.')[0] + '_3'
...
for frame in itemlist:
    ...
    for target in targetlist:
        ...
        if (W >= 100 and speed > 1):
            save_name = FILE + '_FRAME_' + str(frame_id) +  '_IMG_' + str(img_id) + '_' + str(X) + '_' + str(Y) + '_' + str(W) + '_' + str(H) + '_' + '.jpg'
            print(save_name)
